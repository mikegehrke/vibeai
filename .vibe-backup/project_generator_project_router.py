...
class CreateProjectRequest(BaseModel):
    ...
    framework: str = Field(..., description="Framework type: flutter, react, nextjs, node")
    project_name: str = Field(..., description="Name of the project")
    description: Optional[str] = Field(None, description="Project description")
    options: Optional[Dict] = Field(default_factory=dict, description="Framework-specific options")
...
async def create_project(request: CreateProjectRequest):
    ...
    try:
        ...
        # Generate project path
        project_path = get_project_path(request.framework, request.project_name, request.user_id)
        ...
        # Create project
        result = generator.create_project(base_path=project_path, project_name=request.project_name, options=options)
