...
def calculate_token_cost(model: str, input_tokens: int, output_tokens: int, provider: str = "openai") -> float:
    """
...
def get_cheapest_provider(
    input_tokens: int, output_tokens: int, available_providers: list = None
) -> Tuple[str, str, float]:
    """
