...
class AutoFixAgent:
    ...
    async def detect_issues(self, user: str, project_id: str, file_path: str, content: str) -> Dict[str, Any]:
        """
    ...
    async def optimize_imports(self, user: str, project_id: str, file_path: str, content: str) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            return {"success": success, "file": file_path, "imports_optimized": True}
    ...
    async def _write_file(self, user: str, project_id: str, file_path: str, content: str) -> bool:
