...
"""
        ...
        writer.write_file(os.path.join(base_path, "src/controllers/itemController.js"), controller)
...
"""
        ...
        writer.write_file(os.path.join(base_path, "src/middleware/errorHandler.js"), error_handler)
