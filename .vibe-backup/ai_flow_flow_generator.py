...
class FlowGenerator:
    ...
    def _generate_flow_structure(self, flow_type: str, options: Dict[str, Any]) -> Dict[str, Any]:
    ...
    def _create_auth_flow(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        edges = [
            {
                "from_screen": "SplashScreen",
                "to_screen": "LoginScreen",
                "action": "replace",
            ...
            {
                "from_screen": "LoginScreen",
                "to_screen": "RegisterScreen",
                "action": "push",
            },
            {
                "from_screen": "LoginScreen",
                "to_screen": "ForgotPasswordScreen",
                "action": "push",
            },
            {
                "from_screen": "LoginScreen",
                "to_screen": "HomeScreen",
                "action": "replace",
                "condition": "onLoginSuccess",
            },
            {
                "from_screen": "RegisterScreen",
                "to_screen": "HomeScreen",
                "action": "replace",
                "condition": "onRegisterSuccess",
            },
            {
    ...
    def _create_ecommerce_flow(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        edges = [
            ...
            },
            {
                ...
                "to_screen": "ProductDetailScreen",
                "action": "push",
                "params_required": ["id"],
            },
            {
                "from_screen": "ProductDetailScreen",
            ...
            },
            {
                ...
                "to_screen": "AddressScreen",
                "action": "push",
            },
            {
                "from_screen": "AddressScreen",
                "to_screen": "PaymentScreen",
                "action": "push",
            },
            {
                "from_screen": "PaymentScreen",
                "to_screen": "OrderSuccessScreen",
                "action": "replace",
                "params_required": ["orderId"],
            },
            {
                "from_screen": "OrderSuccessScreen",
                "to_screen": "HomeScreen",
                "action": "replace",
            },
        ]
    ...
    def _create_onboarding_flow(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        edges = [
            {
                "from_screen": "SplashScreen",
                "to_screen": "OnboardingStep1Screen",
                "action": "replace",
            }
        ]
    ...
    def _create_social_flow(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        edges = [
            ...
            {
                "from_screen": "FeedScreen",
                "to_screen": "CreatePostScreen",
                "action": "modal",
            },
            {
                "from_screen": "FeedScreen",
                "to_screen": "PostDetailScreen",
                "action": "push",
                "params_required": ["postId"],
            },
            {
                "from_screen": "FeedScreen",
                "to_screen": "SearchScreen",
                "action": "push",
            },
            {
                "from_screen": "FeedScreen",
                "to_screen": "NotificationsScreen",
                "action": "push",
            },
            {
                "from_screen": "FeedScreen",
                "to_screen": "MessagesScreen",
                "action": "push",
            },
            {
                "from_screen": "MessagesScreen",
                "to_screen": "ChatScreen",
                "action": "push",
                "params_required": ["userId"],
            },
        ]
    ...
    def _create_dashboard_flow(self, options: Dict[str, Any]) -> Dict[str, Any]:
        ...
        edges = [
            ...
            {
                "from_screen": "DashboardScreen",
                "to_screen": "UsersScreen",
                "action": "push",
            },
            {
                "from_screen": "UsersScreen",
                "to_screen": "UserDetailScreen",
                "action": "push",
                "params_required": ["id"],
            },
        ]
    ...
    def _generate_flutter_navigation(self, base_path: str, flow_data: Dict[str, Any]) -> List[str]:
    ...
    def _create_flutter_routes(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_flutter_guards(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_flutter_router(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        """Erstellt Flutter app_router.dart"""

        flow_data.get("start_screen", "HomeScreen")
...
"""
    ...
    def _generate_react_navigation(self, base_path: str, flow_data: Dict[str, Any]) -> List[str]:
    ...
    def _create_react_routes(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_react_guards(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _generate_nextjs_navigation(self, base_path: str, flow_data: Dict[str, Any]) -> List[str]:
    ...
    def _create_nextjs_route_file(self, base_path: str, screen: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_nextjs_middleware(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        """Erstellt Next.js middleware.ts"""

        protected_routes = [s["route"] for s in flow_data["screens"] if s.get("requires_auth")]
...
"""
    ...
    def _generate_vue_navigation(self, base_path: str, flow_data: Dict[str, Any]) -> List[str]:
    ...
    def _create_vue_router(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _generate_react_native_navigation(self, base_path: str, flow_data: Dict[str, Any]) -> List[str]:
    ...
    def _create_react_native_navigator(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        """Erstellt React Native Navigation"""

        screens = flow_data["screens"]

        screen_defs = [f"      <Stack.Screen name=\"{s['name']}\" component={{{s['name']}}} />" for s in screens]
