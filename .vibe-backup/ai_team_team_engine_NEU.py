...
"""
        ...
        return await self.collaborate(prompt, team)

    async def design_feature(self, feature_description: str) -> Dict[str, Any]:
        """Team feature design"""
        team = ["lead_developer", "ui_ux_designer", "db_architect"]

        prompt = f"""Design this feature:
