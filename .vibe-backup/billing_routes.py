...
# -------------------------------------------------------------
# VIBEAI – UNIVERSALES BILLING SYSTEM (STRIPE + PAYPAL + TOKENS)
# -------------------------------------------------------------
...
async def get_subscription(current_user=Depends(get_current_user_v2), db=Depends(get_db)):
    """
...
async def cancel_subscription(current_user=Depends(get_current_user_v2), db=Depends(get_db)):
    """
