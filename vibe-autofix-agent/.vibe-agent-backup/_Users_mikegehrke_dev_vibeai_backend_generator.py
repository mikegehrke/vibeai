    ...
    try:
        ...
        if json_match:
            ...
            project_data = {
                ...
                "files": [{"path": "main.txt", "content": content}],
            }
...
class CodeGeneratorV2:
    ...
    async def generate_project(
        ...
        try:
            ...
            # Create Files
            files_created = await self._create_project_files(project_data, output_dir)
            ...
            return {"success": False, "error": str(e), "model_attempted": model_name}
...
"""
        ...
        try:
            ...
            if json_match:
                ...
                return {
                    ...
                    "framework": "unknown",
                    "files": [{"path": "output.txt", "content": response}],
                }
            ...
            return {
                "project_name": "generated-project",
                "framework": "unknown",
                "files": [{"path": "raw_output.txt", "content": response}],
            }

    async def _create_project_files(self, project_data: Dict, output_dir: str) -> List[str]:
    ...
    async def generate_file(
        self, description: str, file_type: str = "python", model: Optional[str] = None
    ) -> Dict[str, any]:
        """
...
"""
        ...
        try:
            result = await model_wrapper.run(
                ...
                context={"max_output_tokens": 4000, "temperature": 0.2},
            )
