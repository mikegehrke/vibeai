...
class NavigationFlowGenerator:
    ...
    def _create_checkout_flow(self) -> Dict[str, Any]:
        ...
        return {"screens": screens, "edges": edges, "entry_point": "CartScreen"}
    ...
    def _create_onboarding_flow(self) -> Dict[str, Any]:
        ...
        return {"screens": screens, "edges": edges, "entry_point": "WelcomeScreen"}
    ...
    def _create_auth_flow(self) -> Dict[str, Any]:
        ...
        return {"screens": screens, "edges": edges, "entry_point": "LoginScreen"}
    ...
    def _create_profile_flow(self) -> Dict[str, Any]:
        ...
        return {"screens": screens, "edges": edges, "entry_point": "ProfileScreen"}
    ...
    def _create_flutter_routes(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        ...
        route_names = "\n".join([f"  static const String {self._to_camel_case(s.name)} = '{s.path}';" for s in screens])

        # Generate route map
        route_map_entries = []
        for screen in screens:
            route_map_entries.append(f"    Routes.{self._to_camel_case(screen.name)}: (context) => {screen.name}(),")
...
"""
    ...
    def _create_flutter_nav_service(self, base_path: str, flow_data: Dict[str, Any]) -> str:
...
"""
    ...
    def _create_react_routes(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        ...
        # Generate imports
        imports = "\n".join([f"import {screen.name} from './screens/{screen.name}';" for screen in screens])
...
"""
    ...
    def _create_react_native_navigator(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        ...
        stack_screens = "\n      ".join(
            [f'<Stack.Screen name="{screen.name}" component={{{screen.name}}} />' for screen in screens]
        )
...
"""
    ...
    def _save_flow_map(self, base_path: str, flow_data: Dict[str, Any]) -> str:
        ...
        os.makedirs(
            os.path.dirname(flow_path) if os.path.dirname(flow_path) else base_path,
            exist_ok=True,
        )
    ...
    def _save_mermaid_chart(self, base_path: str, mermaid: str) -> str:
        ...
        os.makedirs(
            os.path.dirname(chart_path) if os.path.dirname(chart_path) else base_path,
            exist_ok=True,
        )
