      ...
      >
        ...
        <div style={{
          ...
          <p style={{
            ...
            Bring Vibe AI to your entire team with centralized billing and collaboration.
          </p>
          ...
          <div style={{
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Sparkles size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Full Vibe AI Agent access</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Eye size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Unlimited public apps</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Zap size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Advanced AI features</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Cloud size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>10GB storage</span>
                </div>
              </div>
              <Link href="/core/setup" style={{
                marginTop: 'auto',
                width: '100%',
                padding: '0.75rem',
                background: '#3a3a3a',
