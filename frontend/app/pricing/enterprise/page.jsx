...
export default function EnterprisePage() {
  ...
  return (
    <div style={{
      ...
      {/* Left Sidebar - Same as Ultra Plus Setup */}
      <div style={{
        width: '280px',
        background: '#1f1f1f',
        borderRight: 'none',
      ...
      {/* Central Content Area - Teams Pricing Plan */}
      <div style={{
        flex: 1,
        padding: '0',
        overflowY: 'auto',
      ...
      >
        ...
        <div style={{
          ...
          <p style={{
            ...
            Custom solutions for large organizations. Contact our sales team for pricing.
          </p>

          {/* Plan Selector Tabs - Removed for Enterprise (Custom Pricing) */}
          ...
          <div style={{
            ...
            >
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Sparkles size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Everything in Teams</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Users size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Unlimited users</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <FileCode size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Custom contracts & SLA</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  ...
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>On-premise deployment options</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Lock size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Advanced security & compliance</span>
                </div>
              </div>
              <a href="mailto:sales@vibeai.com?subject=Enterprise%20Plan%20Inquiry" style={{
                marginTop: 'auto',
                width: '100%',
                padding: '0.875rem',
                background: '#3b82f6',
