...
export default function UltraSetupPage() {
  const planKey = 'ultra';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <Link href="/ultra-plus/setup" style={{
            width: '100%',
            padding: '0.75rem',
            background: 'transparent',
            color: '#ececec',
          ...
          <div style={{
            ...
            >
              ...
              <p style={{
                ...
                Maximum power for serious development.
              </p>
              <div style={{
                display: 'flex',
                flexDirection: 'column',
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Sparkles size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Everything in Pro+</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Rocket size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Premium Editor with live collaboration</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <Lock size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Unlimited projects & apps</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <DollarSign size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>50€ monthly credits</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                  <ArrowUp size={16} color="#999" />
                  <span style={{ fontSize: '0.85rem', color: '#ececec' }}>Premium AI models access</span>
                </div>
              </div>
              <Link href={`/pricing/ultra/checkout?yearly=${isYearly}`} style={{
                marginTop: 'auto',
                width: '100%',
                padding: '0.875rem',
                background: '#3b82f6',
