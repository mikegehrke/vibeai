...
class IntelligentAgentRouter:
    ...
    def __init__(self):
        ...
        self.agent_capabilities = {
            ...
            "cora": ["code", "programming", "debug", "fix", "function", "class", 
                     "python", "javascript", "typescript", "java", "c++", "rust",
                     "algorithm", "refactor", "optimize"],
            "devra": ["reasoning", "analysis", "explain", "why", "how", 
                      "research", "deep", "complex", "logic", "philosophy"],
            "lumi": ["creative", "story", "poem", "design", "art", "ideas",
                     "brainstorm", "innovative", "imagine", "writing"],
            "vision": ["image", "picture", "photo", "visual", "generate image",
                       "create image", "draw", "illustration"],
            "app_builder": ["app", "flutter", "react native", "android", "ios",
                           "mobile", "screen", "ui", "interface", "swift", "kotlin"],
            "code_studio": ["file", "modify", "refactor", "edit code", "change code",
                           "update file", "fix file", "project"],
        ...
        self.orchestration_keywords = [
            "build app", "create project", "full application",
            "complete system", "end-to-end", "entire project"
        ]
        
        # Safety keywords
        self.safety_keywords = [
            "hack", "exploit", "illegal", "harmful", "nsfw",
            "violence", "weapon", "drug", "abuse"
        ]
...
async def orchestrate_agents(
    ...
    # Orchestrate
    result = await intelligent_router.orchestrate(
        task=task,
        agents=agents,
        context=context,
        user=user,
