...
class FileManager:
    ...
    def create_file(
        ...
        """
        # Get project path
        project_path = project_manager._get_project_path(
        ...
        logger.info(
            "Created file %s in project %s", filename, project_id
        )
    ...
    def update_file(
        ...
        logger.info(
            "Updated file %s in project %s", filename, project_id
        )
    ...
    def delete_file(
        ...
        logger.info(
            "Deleted file %s from project %s", filename, project_id
        )
