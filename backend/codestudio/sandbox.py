...
class Sandbox:
    ...
    async def execute(self, executor, code: str, stdin: str = "") -> Dict[str, Any]:
        """
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            try:
                ...
                result = await asyncio.wait_for(self._run_process(command, stdin), timeout=self.timeout)
    ...
    async def _run_process(self, command: list, stdin: str) -> Dict[str, Any]:
        """
