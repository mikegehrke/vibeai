...
class UnifiedPreviewManager:
    ...
    async def reload_preview(
        ...
        try:
            if framework == "flutter":
                ...
                return {
                    "success": True,
                    "message": "HMR active (auto-reload)"
                }
    ...
    async def _start_flutter(
        ...
        from preview.flutter_preview import flutter_preview_manager
        return await flutter_preview_manager.start_server(
            project_path,
            port=port
        )

    async def _start_react(
        self,
        project_path: str,
        port: int
    ) -> Dict:
        ...
        from preview.react_preview import react_preview_manager
        return await react_preview_manager.start_server(
            project_path,
            port=port
        )

    async def _start_vue(
        self,
        project_path: str,
        port: int
    ) -> Dict:
