...
async def analyze_code(request: AnalyzeCodeRequest):
    ...
    """
    try:
        screens = flowchart_analyzer.detect_screens_from_code(
            request.code,
            request.framework
        )
        
        edges = flowchart_analyzer.detect_navigation_from_code(
            request.code,
            request.framework
        )
