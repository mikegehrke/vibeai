...
class DatabaseGenerator:
    ...
    def _generate_supabase(self, base_path: str, schema: Dict) -> Dict[str, Any]:
        ...
        # Supabase Config
        files["config.js"] = '''// Supabase Configuration
...
'''
        ...
        # Client Helper
        files["client.ts"] = '''// Supabase Client Helpers
...
'''
        ...
        # Database Helpers
        files["helpers.ts"] = '''// Database Helpers
...
'''
        ...
        # .env Template
        files[".env.example"] = '''DATABASE_URL="postgresql://user:password@localhost:5432/mydb"
'''
    ...
    def _generate_firebase(self, base_path: str, schema: Dict) -> Dict[str, Any]:
        ...
        # Firebase Config
        files["config.js"] = '''// Firebase Configuration
...
'''
        ...
        # Firestore Helpers
        files["firestore.js"] = '''// Firestore Helpers
...
'''
        ...
        # Auth Helpers
        files["auth.js"] = '''// Firebase Auth Helpers
...
'''
        ...
        rules_lines = ["rules_version = '2';", "service cloud.firestore {", "  match /databases/{database}/documents {"]
        ...
        for table in schema.get("tables", []):
            ...
            rules_lines.append(f"      allow write: if request.auth != null && request.auth.uid == resource.data.userId;")
...
'''
        ...
        # .env Template
        files[".env.example"] = '''NEXT_PUBLIC_FIREBASE_API_KEY=your-api-key
...
'''
    ...
    def _generate_mongodb(self, base_path: str, schema: Dict) -> Dict[str, Any]:
        ...
        for table in schema.get("tables", []):
            ...
            model_code.append("")
            model_code.append(f"export default mongoose.models.{model_name} || mongoose.model('{model_name}', {schema_name})")
            
            files[f"models/{model_name}.js"] = "\n".join(model_code)

        # Connection
        files["connection.js"] = '''// MongoDB Connection
import mongoose from 'mongoose'
...
'''
        ...
        # .env Template
        files[".env.example"] = '''MONGODB_URI=mongodb://localhost:27017/mydb
# or MongoDB Atlas:
...
'''
    ...
    def _generate_sqlite(self, base_path: str, schema: Dict) -> Dict[str, Any]:
        ...
        # Node.js Client
        files["client.js"] = '''// SQLite Client (better-sqlite3)
