...
def demo_productivity_app():
    ...
    print(f"  - Splash Screens: {len(result.splash_exports['ios']['launch_screen'])} iOS + {len(result.splash_exports['android']['splash_screen'])} Android")
...
def demo_fitness_tracker():
    ...
    print(f"  - Icon Exports: {len(result.icon_exports['ios']['app']) + len(result.icon_exports['android']['app'])} files")
    print(f"  - Splash Exports: {len(result.splash_exports['ios']['launch_screen']) + len(result.splash_exports['android']['splash_screen'])} files")
